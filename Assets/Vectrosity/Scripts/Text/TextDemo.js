...
function Start () {
	...
	Vector.MakeTextInLine (textLine, text, Vector2(Screen.width/2 - text.Length*textSize/2, Screen.height/2 + textSize/2), textSize);
}
...
function Update () {
	...
	Vector.DrawLine (textLine, transform);
}